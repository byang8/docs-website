...
For more on how to find and use your data, see [Elasticsearch's advanced configuration](/docs/infrastructure/host-integrations/host-integrations-list/elasticsearch/elasticsearch-config).
